import argparse
import os
from floorplan_model.util import util
import torch
...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--name', type=str, default='floorplan', help='name of the experiment. It decides where to store samples and models')
        self.parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        self.parser.add_argument('--checkpoints_dir', type=str, default='./model', help='models are saved here')
        ...
        # for setting inputs
        # self.parser.add_argument('--dataroot', type=str, default='F:\MaSonghao\data\class\\resnet34\qipao')
        ...
        self.parser.add_argument('--n_blocks_global', type=int, default=12, help='number of residual blocks in the global generator network')
